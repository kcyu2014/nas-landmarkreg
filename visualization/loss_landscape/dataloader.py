...
def _data_transforms_cifar10(cutout_size, raw_data=False):
    ...
    train_transform = transforms.Compose(ts)
    ...
    if not raw_data:
        vts.append(transforms.Normalize(CIFAR_MEAN, CIFAR_STD))
    valid_transform = transforms.Compose(vts)
...
def load_dataset(dataset='cifar10', datapath='cifar10/data', batch_size=128, \
    ...
    if dataset == 'cifar10':
        ...
        #         normalize,
        #     ])
        transform, test_transform = _data_transforms_cifar10(None, raw_data)
