...
class Network(nn.Module):
    ...
    def __init__(self, C, num_classes, layers, criterion, steps=4, multiplier=4, stem_multiplier=3):
        ...
        C_curr = stem_multiplier*C    # 3 * 16 = 48, should set to 20.
    ...
    def forward(self, input):
        # TODO Study the alphas_reduced and alphas_normal, to make sure understanding and modifying for the NASBench.
