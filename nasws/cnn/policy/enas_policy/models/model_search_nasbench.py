...
from nasws.cnn.search_space.nasbench101.operations import conv_bn_relu, nasbench_vertex_weight_sharing
...
class NasBenchNetSearchENAS(NasBenchNet):
    ...
    def __init__(self, args, config=NASBENCH_CONFIG, cell_cls=NasBenchCellSearch):
        ...
        super(NasBenchNetSearchENAS, self).__init__(input_channels, model_spec, config, cell_cls, args)
