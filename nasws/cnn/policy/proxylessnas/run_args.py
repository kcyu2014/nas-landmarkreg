...
parser.add_argument('--random_arch_seed', default=1268, type=int)
...
parser.add_argument(
    ...
    choices=['proxyless_gpu', 'proxyless_cpu', 'proxyless_mobile', 'proxyless_mobile_14', 'random_mobile']
)
parser.add_argument('--dropout', type=float, default=0)


proxyless_run_args = parser.parse_args("")