...
__all__ = ['MNASNet_ImageNet', 'mnasnet0_5', 'mnasnet0_75', 'mnasnet1_0', 'mnasnet1_3']
...
class MNASNet_ImageNet(torch.nn.Module):
    """ MNASNet, as described in https://arxiv.org/pdf/1807.11626.pdf. This
    implements the B1 variant of the model.
    >>> model = MNASNet_ImageNet(1000, 1.0)
    ...
    def __init__(self, alpha, num_classes=1000, dropout=0.2):
        super(MNASNet_ImageNet, self).__init__()
        assert alpha > 0.0
        self.alpha = alpha
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        super(MNASNet_ImageNet, self)._load_from_state_dict(
...
def mnasnet0_5(pretrained=False, progress=True, **kwargs):
    ...
    """
    model = MNASNet_ImageNet(0.5, **kwargs)
    if pretrained:
...
def mnasnet0_75(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet_ImageNet(0.75, **kwargs)
    if pretrained:
...
def mnasnet1_0(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet_ImageNet(1.0, **kwargs)
    if pretrained:
...
def mnasnet1_3(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    model = MNASNet_ImageNet(1.3, **kwargs)
    if pretrained:
