...
#  All Rights Reserved.
#  Last modified: 2019/11/21 下午1:43
...
#   Reference:
#   Cai et al. 2019, Once for all: paper, ICLR 2019
#  ========================================================
...
from .elastic_utils import get_same_padding, sub_filter_start_end, make_divisible, SEModule
...
class DynamicBatchNorm2d(nn.Module):
    """ This is interesting. """
    # only use part of the parameters.
