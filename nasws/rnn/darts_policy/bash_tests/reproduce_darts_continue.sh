python3.6 search_main.py --epochs=4000 \
                          ...
                          --main_path=darts_policy/tests_dir/date_20190502-160224_geno_id_None_search_policy_darts_nodes_8_use_leaf_False_start_seed_3_cuda9 \
                          --resume_path=EXP_search_SEED_3_eval_seed_1267_geno_id_0_20190502-160224
